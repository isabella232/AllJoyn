...
//        Logger.setTag("MyApp"); // Set custom api logging tag
    ...
    private RemoteDeckOfCards createDeckOfCards(){
        ...
        // Card 1
        SimpleTextCard simpleTextCard= new SimpleTextCard("card1", "My Header", System.currentTimeMillis(), "Title 1", new String[]{"Card 1: line 1", "Card 1: line 2", "Card 1: line 3"});
        simpleTextCard.setInfoText("Current Time: " + formattedDate);
